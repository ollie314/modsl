...
public class UMLClass1TranslatorTest extends AbstractUMLTest {
    ...
    public void process1cvm() throws Exception {
        ic.collect("c1cvm", translator.translate("class diagram c1cvm { abstract class class1 { v1; #m1(); v2; abstract +m2(); #v3; -m3(); } }"), "png");
    }
    ...
    public void process1mp() throws Exception {
        ic.collect("c1mp", translator.translate("class diagram c1mp { class class1 { #m1(p1,     p2, p3):void; } }"), "png");
    }
