...
<rect x="$lx" y="${ly - config.connectorFT.baseline}" width="$labelw" height="${(int)config.connectorFT.fontSize+1}" class="connector_text_background"/>
<text x="$lx" y="$ly" class="connector_text" font-size="$config.connectorFT.fontSize">$connector.name</text>
