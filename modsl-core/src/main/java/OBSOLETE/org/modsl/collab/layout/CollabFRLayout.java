...
package OBSOLETE.org.modsl.collab.layout;
...
import OBSOLETE.org.modsl.collab.CollabDiagramLayoutProps;
import OBSOLETE.org.modsl.core.layout.AbstractLayout;
import OBSOLETE.org.modsl.core.model.XY;
import OBSOLETE.org.modsl.core.model.graph.Edge;
import OBSOLETE.org.modsl.core.model.graph.Graph;
import OBSOLETE.org.modsl.core.model.graph.Vertex;
 ...
 * @author avishnyakov
 */
public class CollabFRLayout extends AbstractLayout<Graph, CollabDiagramLayoutProps> {

    private Logger log = Logger.getLogger(this.getClass());

    protected double temp, kForce, kAttraction, kRepulsion;

    public CollabFRLayout(CollabDiagramLayoutProps props) {
        super(props);
    }
