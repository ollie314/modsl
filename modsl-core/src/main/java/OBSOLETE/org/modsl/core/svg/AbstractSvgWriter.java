...
package OBSOLETE.org.modsl.core.svg;
...
import OBSOLETE.org.modsl.core.model.diagram.AbstractDiagramObject;
import OBSOLETE.org.modsl.core.model.diagram.Diagram;

public abstract class AbstractSvgWriter<D extends Diagram, TP extends AbstractTemplateProps> {
	...
	public AbstractSvgWriter(TP props) {
		this.props = props;
	}
	...
	private String getTemplateFileName(String element) {
		return props.getPath() + "/" + props.getName() + "/" + element + TEMPLATE_FILE_EXT;
	}
