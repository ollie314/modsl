...
public class UMLClassFactory extends AbstractUMLFactory {
	...
	public void createClassNode(Graph parent, Token token, List<NodeLabel> elements, List<Token> extendTokens,
			List<Token> implementTokens, LinkedList<String> aggs) {

		Node n = createNode(parent, token, UMLMetaType.CLASS_CLASS_NODE, UMLMetaType.CLASS_CLASS_NODE_LABEL, elements,
				extendTokens, implementTokens);
	...
	public void createInterfaceNode(Graph parent, Token token, List<NodeLabel> elements, List<Token> extendTokens) {
		createNode(parent, token, UMLMetaType.CLASS_INTERFACE_NODE, UMLMetaType.CLASS_INTERFACE_NODE_LABEL, elements,
				extendTokens, null);
	}
