 ...
 */
public abstract class AbstractConfig<T extends AbstractTemplateProps, L extends AbstractLayoutProps> {
     ...
     * @param name
     */
    public AbstractConfig(String path, String name, T templateProps, L layoutProps) {
        this.path = path;
        this.name = name;
