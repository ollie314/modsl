...
public abstract class AbstractAGTModelTest {
    ...
    public void setUp() throws Exception {
        ...
        Edge<TMetaType> e1_5 = new Edge<TMetaType>(TMetaType.EDGE, "e1_5", n1, n5);
        root.add(e1_5);

        Edge<TMetaType> e2_5 = new Edge<TMetaType>(TMetaType.EDGE, "e2_5", n2, n5);
        root.add(e2_5);

        Edge<TMetaType> e7_5 = new Edge<TMetaType>(TMetaType.EDGE, "e7_5", n7, n5);
        root.add(e7_5);
